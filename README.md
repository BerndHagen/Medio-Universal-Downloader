...
- **Playlist Downloads:** Download entire playlists at once, saving time and effort - especially helpful for bulk offline viewing.
...
- **Universal Downloads:** Access content from numerous platforms and websites, making this a truly universal downloader for your media needs.
...
The Basic license tier supports YouTube video and audio downloads in multiple formats at no cost. Premium licenses unlock **YouTube playlist** downloads, while Ultimate licenses provide support for **additional platforms** beyond YouTube. After purchasing through Stripe's secure payment system, you'll receive your license key via email from Arctisoft-Studio within **5-10 minutes**. 
...
| Cloud-synced settings and statistics on current device                                        |          ✔         |          ✔          |           ✔          |
| Privacy control: disable download history tracking                                             |          ✔         |          ✔          |           ✔          |
...
| Cross-device profile synchronization via license key                                     |          ✖         |          ✔          |           ✔          |
| Persistent cloud profile (never auto-deleted)                                     |          ✖         |          ✔          |           ✔          |
...
Medio uses a cloud-first architecture designed for data persistence and seamless synchronization across devices (Premium/Ultimate only). When you first launch the application, a cloud profile is automatically created behind the scenes - no registration, email, or personal information required.
...
- **Multi-Device Sync (Premium/Ultimate):** License key holders can access their profile from any device by entering their key
...
- **Cross-Device Sync:** Premium/Ultimate users can seamlessly switch between devices without reconfiguring
...
- **License Status:** Current license type (Basic, Premium, Ultimate), trial usage
- **Avatar:** Profile picture if you've uploaded one
- **General Settings:** Buffer size, video format preference (MP4/MKV/AVI/WEBM/WMV/MOV), audio format preference (MP3/OGG/WAV/M4A/AAC/WMA)
- **Advanced Settings:** Hardware acceleration, download speed limit, download history tracking, audio normalization level, metadata embedding, video codec
...
- **Premium/Ultimate License:** Accounts are retained indefinitely

**Deleting Your Data:**
- **Individual History Entries:** Right-click any entry in the History tab → Delete
- **Complete Account Deletion:** Navigate to Settings and press `Ctrl+Shift+D` to open the account deletion dialog, or wait 180 days of inactivity for automatic deletion (Basic accounts only)
...
License keys serve two critical purposes: unlocking Premium/Ultimate features and enabling cross-device profile access.
...
- **Premium/Ultimate Benefit:** Your license key is your "passport" to access your profile from any device, anytime
- **Device Security:** License keys can be activated on up to 2 devices simultaneously for security purposes
- **Profile Persistence:** Premium/Ultimate profiles are never automatically deleted - they're retained indefinitely
...
Basic users can try selected Premium features with this one-time trial license key. It provides faster download speeds, YouTube playlist downloads and expanded history storage up to 50 entries. The trial is limited to **10** downloads before Premium features are disabled.
...
Once redeemed, this key becomes invalid and can't be used again. After reaching the download limit, Premium features will no longer be accessible. Note: This trial key is only available for Basic license users - Premium and Ultimate users already have access to these features.
...
All settings sync automatically across devices for Premium/Ultimate users.
...
A: Since Medio requires internet connectivity for downloads anyway, cloud storage provides valuable benefits at no additional cost: automatic settings backup, persistent progress tracking even after Windows reinstalls, and cross-device synchronization for Premium/Ultimate users. For Basic users who prefer complete privacy, you can disable history tracking - only minimal statistics (download counts, XP) will be stored for the gamification system.
...
A: The speed limitations help manage server infrastructure and bandwidth costs while still providing full functionality for YouTube downloads. Premium and Ultimate licenses remove these restrictions for users who need faster downloads or multi-platform support.
...
- Navigate to Settings and press `Ctrl+Shift+D` to open the account deletion dialog, then type "DELETE" to confirm
- **Basic accounts:** Alternatively, wait 180 days of inactivity for automatic deletion
- **Premium/Ultimate accounts:** Can also use the deletion dialog or contact support via GitHub issue tracker
...
A: Basic users lose access to their cloud profile when switching devices or reinstalling Windows. Your cloud profile will be automatically deleted after 180 days of inactivity. To maintain persistent access across devices, upgrade to Premium or Ultimate - your license key becomes your "passport" to retrieve your profile from any device.

**Q: Can I use the same license key on multiple devices?**

A: Yes! Premium/Ultimate license keys enable profile synchronization across all your devices. Enter the same key on a new device to retrieve your settings, statistics, and history. Basic licenses don't support cross-device sync.
...
<table>
  ...
  <tr>
    <td><a href="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_dashboard.png" target="_blank" rel="noopener noreferrer"><img src="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_dashboard.png" alt="Medio Dashboard" width="450"></a></td>
    <td><a href="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_converter.png" target="_blank" rel="noopener noreferrer"><img src="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_converter.png" alt="Medio Downloader" width="450"></a></td>
  </tr>
  <tr>
    <th>Medio - History</th>
  ...
  <tr>
    <td><a href="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_history.png" target="_blank" rel="noopener noreferrer"><img src="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_history.png" alt="Medio History" width="450"></a></td>
    <td><a href="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_licenses.png" target="_blank" rel="noopener noreferrer"><img src="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_licenses.png" alt="Medio Licenses" width="450"></a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_redeem.png" target="_blank" rel="noopener noreferrer"><img src="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_redeem.png" alt="Medio Activation" width="450"></a></td>
    <td><a href="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_settings.png" target="_blank" rel="noopener noreferrer"><img src="https://github.com/BerndHagen/Medio-Universal-Downloader/raw/main/img/img_v1.7.2-medio_settings.png" alt="Medio Settings" width="450"></a></td>
  </tr>
</table>
